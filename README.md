...
[![Build status][travis_img_url]][travis_page_url] [![Dependency Status](https://david-dm.org/mozilla/node-convict.svg)](https://david-dm.org/mozilla/node-convict) [![devDependency Status](https://david-dm.org/mozilla/node-convict/dev-status.svg)](https://david-dm.org/mozilla/node-convict#info=devDependencies) [![Coverage Status](https://coveralls.io/repos/daoudi-abderrahmane/node-convict/badge.svg?branch=master)](https://coveralls.io/r/daoudi-abderrahmane/node-convict?branch=master)
